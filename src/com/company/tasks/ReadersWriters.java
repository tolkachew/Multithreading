...
public class ReadersWriters {
    static int numReaders = 3; //Максимальное количество
    static int numWriters = 3;
    ...
    public static void main(String[] args) {
        ...
        List<Thread> list = Stream.generate(()->random.nextInt(2)==0?new Thread(new Reader()): new Thread(new Writer()))
                .limit(20)
